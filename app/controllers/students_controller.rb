...
binding.pry
    ...
    if Student.where(linkedin_id:linkedin_id).first.nil?
      ...
      @student= Student.new(first_name: linkedin_data["firstName"], last_name: linkedin_data["lastName"], linkedin_id:linkedin_id, linkedin_url: linkedin_data["publicProfileUrl"], img_url: linkedin_data["pictureUrl"], email: linkedin_data["emailAddres"])
